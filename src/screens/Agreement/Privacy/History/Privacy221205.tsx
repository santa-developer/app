    ...
    <View>
      ...
      >
        ...
        <View style={{ marginBottom: 10 }}>
          ...
          <SubContents
            numbering="⓸"
            contents={`서비스 이용과정에서 생성 및 처리되는 항목`}
            subContents={[
              {
                subNumbering: '·',
                subContents: `기기 정보(OS, 기기고유정보, 언어정보), IP 주소, 서비스 이용기록, 쿠키, 고유 식별자 등`,
              },
            ]}
          />
        </View>
        ...
        <View style={{ marginBottom: 10 }}>
          ...
          <View style={{ paddingHorizontal: 30 }}>
            ...
            >
              ...
              <Text
                style={{ fontSize: 10, color: Colors.nagative }}
              >{`회사의 개인정보 제3자 제공 현황은 아래와 같습니다.`}</Text>
            </View>
          </View>
          <View
            style={{
        ...
        <View style={{ marginBottom: 10 }}>
          ...
          <SubContents
            numbering="-"
            contents={`수탁업체 및 위탁목적 기재(없으면 제1항 삭제)`}
          />
          ...
          <View style={{ marginTop: 10 }}>
            <SubContents
              numbering="3."
              contents={`개인정보 제공 국외 업체`}
            />
            <SubContents
              contents={`회사는 다음과 같은 개인정보를 이용자의 사전동의를 받아 국외 제3자에게 제공하고 있습니다.`}
        ...
        <View style={{ marginBottom: Layout.headerHeight * 2 }}>
          ...
          <SubContents
            contents={`1. 본 개인정보처리방침은 2022년 12월 5일 부터 시행됩니다.`}
          />
          <SubContents
...
const Article2_3 = [
  ...
  {
    subNumbering: '-',
    subContents: '신규 서비스(제품) 개발 및 특화',
  },
  {
    subNumbering: '-',
    subContents: '인구통계학적 특성에 따른 서비스 제공 및 광고 게재',
  },
  {
    subNumbering: '-',
  ...
  },
  {
    subNumbering: '-',
    subContents:
      '경품행사, 이벤트, 회사소식 등 광고성 정보 전달 또는 회원 참여공간 운영',
  },
  {
    subNumbering: '-',
    subContents: '고객설문조사',
...
const Article3_1 = [
  {
    subNumbering: '·',
    subContents: '필수 항목: 이메일 주소, 생년월일, 비밀번호',
  },
  {
    subNumbering: '·',
    subContents: '선택 항목: 계정(ID)',
  },
]
const Article3_2 = [
  {
    subNumbering: '·',
    subContents:
      '필수 항목: 관심분야, 디지털자산 주소 등 암호화폐 전송/수신에 관한 정보(계정 및 인증 정보 및 연락처 등와 같은 결제 정보 포함)',
  },
  {
    subNumbering: '·',
    subContents:
      '선택 항목: 회원이 보거나 참여하는 콘텐츠의 유형, 사용하는 기능, 수행하는 행동, 교류하는 사람 또는 계정, 활동 시간, 빈도 및 기간 등 회원이 서비스를 이용하는 방법에 대한 정보(예 :서비스 이용 시간, 마지막 이용 시간, 서비스에서 확인한 콘텐츠)',
  },
  {
    subNumbering: '·',
    subContents:
      '회원의 활동정보(컨텐츠 게시, 보팅, 댓글 등 활동패턴)를 수집하여 회원의 행동을 기반으로 회원을 관련시키고 회원과 연결된 사람, 계정, 해시 태그 등에 대한 정보 및 이들과 연락하는 방식에 대한 정보를 수집.',
  },
  {
    subNumbering: '·',
    subContents:
      '회원이 서비스를 이용(콘텐츠 작성/공유, 댓글 작성, 다른 사람과의 메시지 전송 등 커뮤니케이션, 프로필 설정 등)시 제공하는 콘텐츠, 커뮤니케이션 및 기타 정보(사진 촬영 장소, 파일 생성일자 등 콘텐츠에 포함되거나 메타데이터 등 관련 정보 포함될 수 있음)',
  },
]
const Article6_3 = [
  {
