 ...
 * @returns
 */
function DormantEmail(): React.JSX.Element {
  const setIsLoggedIn = useSetRecoilState(isLoggedInState)
  // const [loginedUserInfo, setLoginedUserInfo] = useResetRecoilState(
 ...
 * navigation 옵션
 */
DormantEmail.navigationOptions = (): StackNavigationOptions => {
  return CommonHeader({
